...
public class App 
{
    public static void main( String[] args )
    {
     ...
     College college= (College) contest.getBean("collegeBean");
     Principal prince=(Principal)contest.getBean("principleInfo");
       college.display();
       System.out.println("Calling principal");
       prince.principalInfo();
    }
}
